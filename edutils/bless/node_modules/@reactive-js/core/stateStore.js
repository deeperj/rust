...
const toStateStore = () => streamable$1 => streamable.createStreamable(updates => observable.using(scheduler => {
    ...
    const updatesSubscription = functions.pipe(updates, observable.zipWithLatestFrom(stream, (updateState, prev) => updateState(prev)), observable.subscribe(scheduler, stream.dispatch, stream));
