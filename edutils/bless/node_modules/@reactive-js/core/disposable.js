 ...
 */
const bindDisposables = (a, b) => {
    addDisposable(a, b);
    addDisposable(b, a);
};
const toDisposeOnErrorTeardown = (disposable) => (error) => {
    if (option.isSome(error)) {
        functions.pipe(disposable, dispose(error));
    }
};
/**
 ...
 */
const toErrorHandler = (disposable) => cause => functions.pipe(disposable, dispose({ cause }));
...
class AbstractSerialDisposable extends AbstractDisposable {
    ...
    set inner(newInner) {
        ...
        if (oldInner !== newInner) {
            ...
            functions.pipe(oldInner, dispose());
        }
    }
}
...
const createDisposableValue = (value, cleanup) => {
    ...
    addTeardown(retval, functions.defer(value, cleanup));
    return retval;
};
...
exports.addDisposableDisposeParentOnChildError = addDisposableDisposeParentOnChildError;
exports.addOnDisposedWithError = addOnDisposedWithError;
exports.addOnDisposedWithErrorTeardown = addOnDisposedWithErrorTeardown;
exports.addOnDisposedWithoutError = addOnDisposedWithoutError;
exports.addOnDisposedWithoutErrorTeardown = addOnDisposedWithoutErrorTeardown;
exports.addTeardown = addTeardown;
exports.bindDisposables = bindDisposables;
exports.createDisposable = createDisposable;
exports.createDisposableValue = createDisposableValue;
exports.createSerialDisposable = createSerialDisposable;
