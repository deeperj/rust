...
const streamOnSchedulerFactory = (streamable, scheduler, replay) => functions.pipe(streamable, stream(scheduler, { replay }));
const __stream = (streamable, { replay = 0, scheduler, } = {}) => {
    const currentScheduler = observable.__currentScheduler();
    return observable.__using(streamOnSchedulerFactory, streamable, scheduler !== null && scheduler !== void 0 ? scheduler : currentScheduler, replay);
};
