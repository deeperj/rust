...
class MathRequestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<MathRequest> _instance;
} _MathRequest_default_instance_;
class MathReplyDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<MathReply> _instance;
} _MathReply_default_instance_;
}  // namespace mathtest
static void InitDefaultsscc_info_MathReply_mathtest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mathtest::_MathReply_default_instance_;
    new (ptr) ::mathtest::MathReply();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mathtest::MathReply::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MathReply_mathtest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MathReply_mathtest_2eproto}, {}};

static void InitDefaultsscc_info_MathRequest_mathtest_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mathtest::_MathRequest_default_instance_;
    new (ptr) ::mathtest::MathRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mathtest::MathRequest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MathRequest_mathtest_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MathRequest_mathtest_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mathtest_2eproto_sccs[2] = {
  &scc_info_MathReply_mathtest_2eproto.base,
  &scc_info_MathRequest_mathtest_2eproto.base,
};
...
static bool dynamic_init_dummy_mathtest_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mathtest_2eproto)), true);
namespace mathtest {
...
const MathRequest& MathRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_MathRequest_mathtest_2eproto.base);
...
const MathReply& MathReply::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_MathReply_mathtest_2eproto.base);
  return *internal_default_instance();
}
